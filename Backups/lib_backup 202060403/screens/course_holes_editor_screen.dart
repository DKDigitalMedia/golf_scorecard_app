...
class _CourseHolesEditorScreenState
  ...
  final List<TextEditingController> _siCtrls = List.generate(
    18,
    (_) => TextEditingController(),
  );
  final List<TextEditingController> _yardCtrls = List.generate(
    18,
    (_) => TextEditingController(),
  );
  ...
  Future<void> _saveAll() async {
    ...
    if (tee != null) {
      for (int i = 0; i < 18; i++) {
        ...
        final validYard = (yard == null || yard == 0)
            ? null
            : yard.clamp(1, 650);
